# Product Requirements Document — Mr.Card Marketing & Verification Website

**Product:** 名片先生 Mr.Card marketing website (`mcard-web`)
**Owner:** 名片先生 Mr.Card
**Status:** v1
...
名片先生 / Mr.Card (internal name **RenMaiTong**, bundle ID `com.astralweb.renmaitong`) is a
...
- **Hero** — product name (名片先生 / Mr.Card), one-line value prop, a stylized
